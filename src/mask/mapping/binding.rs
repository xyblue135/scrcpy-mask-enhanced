...
impl ButtonBinding {
    ...
    pub fn is_any_key_just_pressed(&self, key_input: &ButtonInput<KeyCode>) -> bool {
        self.0
            .iter()
            .any(|btn| matches!(btn, MergedButton::Keyboard(k) if key_input.just_pressed(*k)))
    }

    pub fn is_any_mouse_just_pressed(&self, mouse_input: &ButtonInput<MouseButton>) -> bool {
        self.0
            .iter()
